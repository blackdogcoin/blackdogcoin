...
static const int64_t nTargetTimespan_legacy = nTargetSpacing * nRetarget; // every 1 blocks
...
const string strMessageMagic = "blackdogcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "blackdogcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "blackdogcoin x11";
        CTransaction txNew;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("bd4d2c9c69ab1a833496d4b3bb4d25cb1c5a1014596bbfa9ff31162746aa2021"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xbb, 0xcc, 0xdd, 0xee };
